...
{
    internal class UniversalLanchesterLawViewModel : ViewModelBase
    {
        ...
        public RelayCommand CalculateCommand
        {
            get
            {
                ...
                {
                    if (_allyCount == 0 || _allyUnitSquare == 0 || _allySquare == 0 || _allyUnitPower == 0 || _enemyCount == 0 || _enemyUnitPower == 0)
                    {
                        MessageBox.Show("Перевірте параметри. Серед них не має бути 0");
                    }
                    else
                    {
                        var Lanchester = new UniversalLanchesterLaw(_allyCount, _allyUnitSquare, _allySquare, _allyUnitPower, _enemyCount, _enemyUnitPower);
                        /////////
